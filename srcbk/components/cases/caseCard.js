    ...
    return(
        ...
        className="flex flex-col overflow-hidden  rounded-lg shadow-lg">
                <div className="flex-shrink-0">
                  <img id={data.id} className="h-96 w-full transition duration-1000 ease-in-out object-cover" src={data.imageUrl} alt="" />
                </div>
                <div className="flex flex-1 flex-col justify-between bg-white p-6">
                  <div className="flex-1">
                    ...
                    <a href={data.href} className="mt-2 block">
                      ...
                      <p className="mt-3 text-2xl text-justify space-y-2 leading-9 text-gray-500">{data.description}</p>
                    </a>
                  </div>
                </div>
              </Link>
